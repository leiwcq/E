...
namespace E.Serializer.Common
{
        ...
        where TSerializer : ITypeSerializer
    {
        ...
        private static Dictionary<Type, ParseCollectionDelegate> _parseDelegateCache
        ...
        {
            if (_parseDelegateCache.TryGetValue(elementType, out var parseDelegate))
            ...
            do
            {
                ...
                newCache = new Dictionary<Type, ParseCollectionDelegate>(_parseDelegateCache)
                {
