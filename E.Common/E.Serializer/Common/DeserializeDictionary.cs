...
namespace E.Serializer.Common
{
        ...
        where TSerializer : ITypeSerializer
    {
        ...
        public static ParseStringSegmentDelegate GetParseStringSegmentMethod(Type type)
        {
            ...
            var keyTypeParseMethod = Serializer.GetParseStringSegmentFn(dictionaryArgs[KEY_INDEX]);
            if (keyTypeParseMethod == null) return null;

            var valueTypeParseMethod = Serializer.GetParseStringSegmentFn(dictionaryArgs[VALUE_INDEX]);
        ...
        private static Dictionary<TypesKey, ParseDictionaryDelegate> _parseDelegateCache
            ...
            ParseStringSegmentDelegate keyParseFn, ParseStringSegmentDelegate valueParseFn)
        {
            ...
            if (_parseDelegateCache.TryGetValue(key, out parseDelegate))
            ...
            do
            {
                ...
                newCache = new Dictionary<TypesKey, ParseDictionaryDelegate>(_parseDelegateCache);
        ...
        struct TypesKey
        {
            ...
            public TypesKey(Type type1, Type type2)
            {
                ...
                unchecked
                {
                    _hashcode = Type1.GetHashCode() ^ (37 * Type2.GetHashCode());
                }
            }
