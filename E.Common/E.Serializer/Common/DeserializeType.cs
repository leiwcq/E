...
namespace E.Serializer.Common
{
        ...
        where TSerializer : ITypeSerializer
    {
        ...
        public static object ParseQuotedPrimitive(string value)
        {
            ...
            if (value.StartsWith(DateTimeSerializer.ESCAPED_WCF_JSON_PREFIX, StringComparison.Ordinal) || value.StartsWith(DateTimeSerializer.WCF_JSON_PREFIX, StringComparison.Ordinal))
