...
namespace E.Serializer.Csv
{
    ...
    public class CsvReader<T>
    {
        ...
        internal static void Reset()
        {
            ...
            PropertySettersMap = new Dictionary<string, SetMemberDelegate<T>>(E.Common.PclExport.Instance.InvariantComparerIgnoreCase);

            PropertyConverters = new List<ParseStringDelegate>();
            PropertyConvertersMap = new Dictionary<string, ParseStringDelegate>(E.Common.PclExport.Instance.InvariantComparerIgnoreCase);
