...
namespace E.Serializer
{
    ...
    public static class TypeSerializer
    {
        ...
        public static Encoding UTF8Encoding = E.Common.PclExport.Instance.GetUTF8Encoding(false);
        ...
        {
            E.Common.PclExport.Instance.WriteLine(SerializeAndFormat(instance));
        }
        ...
        {
            if (args.Length > 0)
                E.Common.PclExport.Instance.WriteLine(text, args);
            else
                E.Common.PclExport.Instance.WriteLine(text);
        }

        public static void Print(this int intValue)
        {
            E.Common.PclExport.Instance.WriteLine(intValue.ToString(CultureInfo.InvariantCulture));
        }

        public static void Print(this long longValue)
        {
            E.Common.PclExport.Instance.WriteLine(longValue.ToString(CultureInfo.InvariantCulture));
        }
