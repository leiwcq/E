...
namespace E.Interface
{
    ...
    public class RestrictAttribute : AttributeBase
    {
        ...
        {
            get => AccessibleToAny.Length == 0
                ? RequestAttributes.Any
                : AccessibleToAny[0];

            set => AccessibleToAny = new[] { value };
        }
        ...
        {
            get => VisibleToAny.Length == 0
                ? RequestAttributes.Any
                : VisibleToAny[0];

            set => VisibleToAny = new[] { value };
        }
        ...
        {
            AccessTo = RequestAttributes.Any;
            VisibilityTo = RequestAttributes.Any;
        }
        ...
        {
            AccessibleToAny = ToAllowedFlagsSet(restrictAccessAndVisibilityToScenarios);
            VisibleToAny = ToAllowedFlagsSet(restrictAccessAndVisibilityToScenarios);
        }
        ...
        public RestrictAttribute(RequestAttributes[] allowedAccessScenarios, RequestAttributes[] visibleToScenarios)
            : this()
        {
            AccessibleToAny = ToAllowedFlagsSet(allowedAccessScenarios);
            VisibleToAny = ToAllowedFlagsSet(visibleToScenarios);
        }
        ...
        {
            return VisibleToAny.Any(scenario => (restrictions & scenario) == restrictions);
        }

        public bool HasAccessTo(RequestAttributes restrictions)
        {
            return AccessibleToAny.Any(scenario => (restrictions & scenario) == restrictions);
        }

        public bool HasNoAccessRestrictions => AccessTo == RequestAttributes.Any;

        public bool HasNoVisibilityRestrictions => VisibilityTo == RequestAttributes.Any;
    }
